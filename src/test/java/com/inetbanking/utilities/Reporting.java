...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		extent.setSystemInfo("user", "uma");

		htlmreporter.config().setDocumentTitle("inetbanking test project");
		htlmreporter.config().setReportName("Functional test report");
		htlmreporter.config().setTestViewChartLocation(ChartLocation.TOP);
		htlmreporter.config().setTheme(Theme.DARK);
	}
